...
summary: 기준 구글 클라우드 자연어 처리 API 사용법 정리
---
...
- Google Cloud Platform 에서 우리가 사용할 명령 입력 창 Cloud shell 을 열어준다.
  ...
  ![pre1](/assets/google_study_gem/Natural_pre_01.png)

- 아래 같은 창이 뜨는데 **START CLOUD SHELL** 클릭

  ![pre2](/assets/google_study_gem/Natural_pre_02.png)

  ![pre3](/assets/google_study_gem/Natural_pre_03.png)
